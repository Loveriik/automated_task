...
describe('Testing login form page', async () => {
    ...
    describe('UC-1: Test Login form with empty credentials', async () => {
        it('Should display "Username is required" error', async () => {
            try {
    ...
    describe('UC-2: Test Login form with credentials by passing Username', async () => {
        it('Should display "Password is required" error', async () => {
            try {
    ...
    describe('UC-3: Test Login form with credentials by passing Username & Password', async () => {
        it('Should redirect to products page and have the title: "Swag Labs"', async () => {
            try {
